      ...
      var t = function (e) {
        ...
        v = function (t) {
          ...
          ;(t.currentFontSize = parseFloat(
            ...
            (t.whiteSpace =
              i.getPropertyValue("white-space"))
        },
        p = function (e) {
          var t = !1
          return (
      ...
      i &&
        ...
        t(
          ...
          !e.hasAttribute("data-ignore") &&
            e.contentWindow &&
            "function" ==
              typeof e.contentWindow.postMessage &&
            e.contentWindow.postMessage(
...
class S {
  ...
  getSlideNumber(e = this.Reveal.getCurrentSlide()) {
    let t,
      ...
      a = "h.v"
    if ("function" == typeof i.slideNumber)
      t = i.slideNumber(e)
    else {
      "string" == typeof i.slideNumber &&
        (a = i.slideNumber),
        /c/.test(a) ||
          1 !==
          ...
          (a = "c")
      let n =
        e && "uncounted" === e.dataset.visibility
          ? 0
          : 1
      switch (((t = []), a)) {
        case "c":
  ...
  formatNumber(
    ...
    t,
    i,
    a = "#" + this.Reveal.location.getHash()
  ) {
...
class A {
  ...
  sync(e) {
    ...
    e.classList.remove("has-dark-background"),
      ...
      a.backgroundSize &&
        (i.style.backgroundSize = a.backgroundSize),
      a.backgroundRepeat &&
        (i.style.backgroundRepeat =
          a.backgroundRepeat),
      a.backgroundPosition &&
        (i.style.backgroundPosition =
          a.backgroundPosition),
      a.backgroundOpacity &&
        (i.style.opacity = a.backgroundOpacity)
...
class C {
  ...
  run(e, t) {
    ...
    if (
      ...
      !(a > n ? t : e).hasAttribute(
        "data-auto-animate-restart"
      )
    ) {
      this.autoAnimateStyleSheet =
        this.autoAnimateStyleSheet || l()
      let i = this.getAutoAnimateOptions(t)
      ;(e.dataset.autoAnimate = "pending"),
        (t.dataset.autoAnimate = "pending"),
        (i.slideDirection =
          a > n ? "forward" : "backward")
      let s = this.getAutoAnimatableElements(e, t).map(
        (e) =>
      ...
      if (
        ...
        !0 ===
          this.Reveal.getConfig().autoAnimateUnmatched
      ) {
  ...
  autoAnimateElements(e, t, i, a, n) {
    ...
    let o = this.getAutoAnimatableProperties(
        "from",
        e,
        i
      ),
    ...
    if (!1 !== i.translate || !1 !== i.scale) {
      ...
      let a =
        ...
        n =
          !1 !== i.scale &&
          (0 !== t.scaleX || 0 !== t.scaleY)
      if (a || n) {
        let e = []
        a && e.push(`translate(${t.x}px, ${t.y}px)`),
          n &&
            e.push(`scale(${t.scaleX}, ${t.scaleY})`),
    ...
    if (d.length > 0) {
      ;(o.styles.transition = "none"),
        (r.styles.transition = `all ${s.duration}s ${s.easing} ${s.delay}s`),
        (r.styles["transition-property"] =
          d.join(", ")),
  ...
  getAutoAnimateOptions(t, i) {
    ...
    return (
      t.dataset.autoAnimateEasing &&
        (a.easing = t.dataset.autoAnimateEasing),
  ...
  getAutoAnimatableProperties(e, t, i) {
    ...
    return (
      (i.styles || a.autoAnimateStyles).forEach(
        (t) => {
          let i
          "string" == typeof t &&
            (t = { property: t }),
        ...
        s(e.from, a)
          ...
          : s(e.from, "pre") &&
            ...
            this.findAutoAnimateMatches(
              ...
              (e) =>
                e.getAttribute("data-line-number"),
              {
                scale: !1,
                styles: ["width"],
                measure:
  ...
  findAutoAnimateMatches(e, t, i, a, n, s) {
    ...
    ;[].slice
      ...
      [].slice
        .call(i.querySelectorAll(a))
        .forEach((t, i) => {
          const a = n(t)
          let l
          if (
            ((r[a] = r[a] || []), r[a].push(t), o[a])
          ) {
    ...
    return [].slice.call(e.children).reduce((e, t) => {
      ...
      return (
        ...
        t.querySelector(
          ...
          (e = e.concat(
            this.getUnmatchedAutoAnimateElements(t)
          )),
        e
      )
    }, [])
  ...
  sort(e, t = !1) {
    ...
    return (
      i.forEach((e) => {
        e.forEach((e) => {
          n.push(e),
            e.setAttribute("data-fragment-index", s)
        }),
          s++
      }),
      !0 === t ? i : n
  ...
  update() {
    ...
    this.Reveal.transformSlides({
      overview: [
        "scale(" + t + ")",
        "translateX(" +
          -i.h * this.overviewSlideWidth +
          "px)",
        "translateY(" +
          -i.v * this.overviewSlideHeight +
          "px)",
      ].join(" "),
    })
  }
    ...
    if ("object" == typeof t.keyboard)
      for (l in t.keyboard)
        "togglePause" === t.keyboard[l] &&
          d.push(parseInt(l, 10))
    if (this.Reveal.isPaused() && -1 === d.indexOf(i))
      return !1
    let c =
...
class D {
  ...
  getIndicesFromHash(e = window.location.hash) {
    ...
    }
    {
      ...
      if (e)
        return { ...this.Reveal.getIndices(e), f: i }
    }
    return null
  }
  readURL() {
...
class q {
  ...
  async setupPDF() {
    const e = this.Reveal.getConfig(),
      ...
      a =
        e.slideNumber &&
        /all|print/i.test(e.showSlideNumber),
    ...
    i.forEach(function (i, n) {
      if (!1 === i.classList.contains("stack")) {
        let l = (s - r) / 2,
          c = (o - d) / 2
        const v = u[n]
        let p = Math.max(Math.ceil(v / o), 1)
        ...
        if (e.pdfSeparateFragments) {
          ...
          t(m, ".fragment:not(.fade-out)").forEach(
            function (e) {
              e.classList.add("visible")
            }
          )
...
class B {
  ...
  isSwipePrevented(e) {
    ...
    for (
      ;
      e && "function" == typeof e.hasAttribute;
...
function V(s, l) {
  arguments.length < 2 &&
    ((l = arguments[0]),
    (s = document.querySelector(".reveal")))
  const h = {}
  let u,
    g,
    p,
  ...
  function ue(e) {
    ...
    if (
      ((V.wrapper = s),
      (V.slides = s.querySelector(".slides")),
      !V.slides)
    )
    ...
    return (
      ...
      re.load(y.plugins, y.dependencies).then(ve),
      new Promise((e) => h.on("ready", e))
    )
  }
  function ge() {
    !0 === y.embedded
      ? (V.viewport = o(s, ".reveal-viewport") || s)
  ...
  function Re() {
    document.addEventListener("fullscreenchange", Ft),
      document.addEventListener(
  ...
  function Ee(t) {
    const a = { ...y }
    if (
      ("object" == typeof t && e(y, t),
      !1 === h.isReady())
    )
      return
    const n = V.wrapper.querySelectorAll(
      ".slides section"
    ).length
  ...
  function Ae() {
    window.addEventListener("resize", Tt, !1),
      ...
      V.pauseOverlay.addEventListener("click", Xe, !1),
      y.focusBodyOnPageVisibilityChange &&
        document.addEventListener(
          "visibilitychange",
          zt,
          !1
  ...
  function Ce(e) {
    "string" == typeof e.layout &&
      ...
      F.layout
        ? n(V.slides, F.layout + " " + F.overview)
        : n(V.slides, F.overview)
  }
  function Pe({
    target: t = V.wrapper,
    type: i,
  ...
  function Me(e = "a") {
    Array.from(V.wrapper.querySelectorAll(e)).forEach(
      (e) => {
        ;/^(http|www)/gi.test(
          e.getAttribute("href")
        ) && e.addEventListener("click", Ht, !1)
      }
    )
  }
  function De(e = "a") {
    Array.from(V.wrapper.querySelectorAll(e)).forEach(
      (e) => {
        ;/^(http|www)/gi.test(
          e.getAttribute("href")
        ) && e.removeEventListener("click", Ht, !1)
      }
    )
  }
  function Ie(e) {
  ...
  function He() {
    if (V.wrapper && !le.isPrintingPDF()) {
      if (!y.disableLayout) {
        ...
        const i = Array.from(
          V.wrapper.querySelectorAll(".slides section")
        )
        ...
        t !== x &&
          Pe({
            type: "resize",
            data: { oldScale: t, scale: x, size: e },
          })
      }
      se.update(),
        G.updateParallax(),
  ...
  function Be(e, t) {
    ...
    return (
      (i.presentationWidth -=
        i.presentationWidth * y.margin),
      (i.presentationHeight -=
        i.presentationHeight * y.margin),
      "string" == typeof i.width &&
        /%$/.test(i.width) &&
        (i.width =
          (parseInt(i.width, 10) / 100) *
          i.presentationWidth),
      "string" == typeof i.height &&
        /%$/.test(i.height) &&
        (i.height =
          (parseInt(i.height, 10) / 100) *
          i.presentationHeight),
      i
    )
  }
  ...
  function Ze(e, t, i, a) {
    ...
    e: for (let e = 0, t = L.length; e < t; e++) {
      ...
      V.viewport.classList.add(L[e]),
        Pe({ type: L[e] })
    }
    for (; s.length; )
      V.viewport.classList.remove(s.pop())
    l &&
      Pe({
        type: "slidechanged",
        data: {
      ...
      (!l && p) ||
        (J.stopEmbeddedContent(p),
        J.startEmbeddedContent(m)),
      requestAnimationFrame(() => {
        be(ye(m))
      }),
      se.update(),
  ...
  function it(e = ct()) {
    e.forEach((t, i) => {
      ...
      a.parentNode === t.parentNode &&
        t.parentNode.insertBefore(t, a)
  ...
  function nt() {
    ...
    if (n && void 0 !== u) {
      ...
      v &&
        (s = te.isActive() ? 6 : y.mobileViewDistance),
  ...
  function st({ includeFragments: e = !1 } = {}) {
    let t = V.wrapper.querySelectorAll(
        ".slides>section"
      ),
      i = V.wrapper.querySelectorAll(
        ".slides>section.present>section"
      ),
      a = {
        left: u > 0,
    ...
    if (
      ...
      t.length > 1 &&
        "linear" === y.navigationMode &&
        ((a.right = a.right || a.down),
        (a.left = a.left || a.up)),
      !0 === e)
    ) {
  ...
  function rt() {
    ...
    if (m) {
      ...
      if (e.length > 0) {
        let i = 0.9
        t +=
          (m.querySelectorAll(".fragment.visible")
            .length /
            e.length) *
          i
      }
  ...
  function ft(e, t) {
    ...
    return a && a.length && "number" == typeof t
      ? a
        ? a[t]
        : void 0
      : i
  ...
  function wt(e) {
    if ("object" == typeof e) {
      Ze(a(e.indexh), a(e.indexv), a(e.indexf))
      let t = a(e.paused),
        i = a(e.overview)
  ...
  function Rt() {
    if ((St(), m && !1 !== y.autoSlide)) {
      ...
      let i = e
          ...
          : null,
        a = m.parentNode
          ? m.parentNode.getAttribute("data-autoslide")
          : null,
      ...
      i
        ...
        : ((j = y.autoSlide),
          0 ===
            m.querySelectorAll(".fragment").length &&
        ...
        !j ||
          ...
          te.isActive() ||
          ($e() &&
            !ee.availableRoutes().next &&
            !0 !== y.loop) ||
          ((X = setTimeout(() => {
            "function" == typeof y.autoSlideMethod
              ? y.autoSlideMethod()
              : Nt(),
              Rt()
          }, j)),
    ...
    ;(E.hasNavigatedHorizontally = !0),
      y.rtl
        ? (te.isActive() || e || !1 === ee.next()) &&
          ...
          Ze(
            u + 1,
            "grid" === y.navigationMode ? g : void 0
          )
    ...
    if (e || !1 === ee.prev())
      if (st().up) xt({ skipFragments: e })
        ...
        if (
          ...
          let e =
            i.querySelectorAll("section").length - 1 ||
            void 0
          Ze(u - 1, e)
...
;($.initialize = (e) => (
  Object.assign(
    $,
    new V(document.querySelector(".reveal"), e)
  ),
  j.map((e) => e($)),
  $.initialize()
)),
