...
!(function (e, t) {
  ...
  ;(Z.exports = function (e, t, n, i) {
    ...
    return (
      ("function" == typeof this && Ve(this).source) ||
      We(this)
    )
  })
  var $e = n,
  ...
  var Ni = "[object z]" === String(Ci),
    ...
    Ui = Fi
  zi ||
    Hi(Object.prototype, "toString", Ui, {
      unsafe: !0,
    })
  var Bi = n.Promise,
    _i = Z.exports,
    ...
    cr = function (e) {
      if (null != e)
        return e[lr] || e["@@iterator"] || sr[or(e)]
    },
    ur = W,
    dr = function (e) {
      var t = e.return
  ...
  var kr,
    ...
    Nr = function (e, t) {
      var n,
        i = Lr(e).constructor
      return void 0 === i || null == (n = Lr(i)[Cr])
        ? t
        : Pr(n)
    },
  ...
  ;(_r && qr) ||
    ...
    Ur
      ...
      : Or.addEventListener &&
        ...
        !Dr(Zr)
      ? ((kr = Zr),
        Or.addEventListener("message", Qr, !1))
      : (kr =
          Xr in zr("script")
            ? function (e) {
                Fr.appendChild(
  ...
  Sa ||
    ...
    fa || ga || va || !pa || !ma
      ? ba && ba.resolve
        ? (((oa = ba.resolve(void 0)).constructor =
            ba),
          (sa = oa.then),
          (ia = function () {
            sa.call(oa, ea)
  ...
  var xa,
    ...
    xo = ro(co, function () {
      ...
      return (
        ((t.constructor = {})[lo] = n),
        !(Ro = t.then(function () {}) instanceof n) ||
          (!e && ao && !ko)
      )
    }),
    Lo =
    ...
    No = function (e, t, n) {
      ...
      Eo
        ...
        !ko && (r = ja["on" + e])
          ? r(i)
          : e === Ao &&
            eo("Unhandled promise rejection", n)
    },
    Io = function (e) {
      Ja.call(ja, function () {
        var t,
        ...
        if (
          ...
          ((t = no(function () {
            oo
              ? bo.emit("unhandledRejection", i, n)
              : No(Ao, n, i)
          })),
    ...
    zs = function () {
      ...
      zs = ks
        ...
        : (((t = Os("iframe")).style.display = "none"),
          ...
          e.close(),
          e.F)
      for (var n = Is.length; n--; )
        delete zs.prototype[Is[n]]
      return zs()
    }
  Ms[Ds] = !0
  var Hs =
  ...
  var Nl = $e,
    ...
    Ic = Dl.QObject,
    Mc =
      !Ic || !Ic.prototype || !Ic.prototype.findChild,
    Tc =
      Fl &&
      Ul(function () {
        return (
  ...
  Ol(
    { global: !0, wrap: !0, forced: !zl, sham: !zl },
    { Symbol: wc }
  ),
  fc(Gl(Nc), function (e) {
    uc(e)
  ...
  wc.prototype[pc] ||
    ic(wc.prototype, pc, wc.prototype.valueOf),
    dc(wc, gc),
    (oc[vc] = !0)
  var _c = $t,
    qc = a,
  ...
  if (
    qc &&
    "function" == typeof Xc &&
    (!("description" in Xc.prototype) ||
      void 0 !== Xc().description)
  ) {
    var Gc = {},
      Jc = function () {
        var e =
  ...
  nh("replace", 2, function (e, t, n, i) {
    var r =
        i.REGEXP_REPLACE_SUBSTITUTES_UNDEFINED_CAPTURE,
    ...
    return [
      ...
      function (e, i) {
        ...
        for (var f = []; ; ) {
          ...
          if ((f.push(v), !d)) break
          "" === String(v[0]) &&
            (l.lastIndex = sh(c, rh(l.lastIndex), h))
        }
        for (
          var g, p = "", m = 0, y = 0;
          y < f.length;
  ...
  Nu("search", 1, function (e, t, n) {
    return [
      ...
      function (e) {
        ...
        var s = ph(r, a)
        return (
          gh(r.lastIndex, o) || (r.lastIndex = o),
          null === s ? -1 : s.index
        )
      },
    ]
        ...
        var t = function (e) {
          ...
          v = function (t) {
            ...
            ;(t.currentFontSize = parseFloat(
              ...
              (t.whiteSpace =
                n.getPropertyValue("white-space"))
          },
          g = function (e) {
            var t = !1
            return (
          ...
          k = {
            ...
            maxSize: 512,
            multiLine: !0,
            observeMutations: "MutationObserver" in
              e && {
              subtree: !0,
              childList: !0,
              characterData: !0,
          ...
          },
          {
            ...
            value: function (e) {
              ...
              ;(e.style.display =
                ...
                yh(e, "video, audio").forEach(
                  function (e) {
                    var t = 0
                    yh(e, "source[data-src]").forEach(
                      function (e) {
                        e.setAttribute(
                          "src",
                          e.getAttribute("data-src")
              ...
              if (i) {
                ...
                var r =
                    e.slideBackgroundContentElement,
                  a = e.getAttribute(
                    "data-background-iframe"
                  )
                if (
                  !1 === i.hasAttribute("data-loaded")
                ) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                ...
                yh(t, "iframe[src]").forEach(function (
                  e
                ) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              e &&
                ...
                yh(e, "iframe[src]").forEach(function (
                  e
                ) {
                  ;(kh(e, ".fragment") &&
                    !kh(e, ".fragment.visible")) ||
          ...
          },
          {
            ...
            value: function () {
              ...
              if ("function" == typeof n.slideNumber)
                ...
                var r =
                  t &&
                  "uncounted" === t.dataset.visibility
                    ? 0
                    : 1
                switch (((e = []), i)) {
                  case "c":
                    e.push(
                      this.Reveal.getSlidePastCount(
                        t
                      ) + r
                    )
                    break
              ...
              var s =
                "#" + this.Reveal.location.getHash(t)
        ...
        Ri(e, [
            ...
            value: function (e, t, n, i, r) {
              ...
              t.classList.contains("fragment") &&
                ...
                e.classList.contains("fragment") &&
                  (e.className.match(cf) || [
                    "",
                  ])[0] ===
                    (t.className.match(cf) || [
                      "",
                    ])[0] &&
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return {
                x:
                  Math.round(e.offsetLeft * t * 100) /
                  100,
                y:
                  Math.round(e.offsetTop * t * 100) /
                  100,
                width:
                  Math.round(e.offsetWidth * t * 100) /
                  100,
                height:
                  Math.round(
                    e.offsetHeight * t * 100
                  ) / 100,
              }
            },
          },
        ...
        Ri(e, [
          {
            ...
            value: function () {
              ...
              ;(this.element =
                ...
                (this.controlsLeft = yh(
                  t,
                  ".navigate-left"
                )),
                (this.controlsRight = yh(
                  t,
                  ".navigate-right"
                )),
                (this.controlsUp = yh(
                ...
                (this.controlsDown = yh(
                  t,
                  ".navigate-down"
                )),
                (this.controlsPrev = yh(
                  t,
                  ".navigate-prev"
                )),
                (this.controlsNext = yh(
                  t,
                  ".navigate-next"
                )),
              ...
              Oh && (t = ["touchstart"]),
                t.forEach(function (t) {
                  e.controlsLeft.forEach(function (n) {
                    ...
                    e.controlsRight.forEach(function (
                      n
                    ) {
                      return n.addEventListener(
                        t,
                    ...
                    e.controlsDown.forEach(function (
                      n
                    ) {
                      return n.addEventListener(
                        t,
                    ...
                    e.controlsPrev.forEach(function (
                      n
                    ) {
                      return n.addEventListener(
                        t,
                    ...
                    e.controlsNext.forEach(function (
                      n
                    ) {
                      return n.addEventListener(
                        t,
          ...
          },
          {
            ...
            value: function () {
              ...
              ;[]
                ...
                e.left &&
                  this.controlsLeft.forEach(function (
                    e
                  ) {
                ...
                e.right &&
                  this.controlsRight.forEach(function (
                    e
                  ) {
                    e.classList.add("enabled"),
                      e.removeAttribute("disabled")
                ...
                e.down &&
                  this.controlsDown.forEach(function (
                    e
                  ) {
                    e.classList.add("enabled"),
                      e.removeAttribute("disabled")
                ...
                (e.left || e.up) &&
                  this.controlsPrev.forEach(function (
                    e
                  ) {
                    e.classList.add("enabled"),
                      e.removeAttribute("disabled")
                ...
                (e.right || e.down) &&
                  this.controlsNext.forEach(function (
                    e
                  ) {
                    e.classList.add("enabled"),
                      e.removeAttribute("disabled")
      ...
      return (
        Ri(e, [
          ...
          },
          {
            ...
            value: function (e) {
              if (
                Date.now() - this.lastMouseWheelStep >
                1e3
              ) {
            ...
            value: function () {
              return (
                ...
                this.asyncDependencies.length &&
                  this.asyncDependencies.forEach(
                    function (e) {
                      Rf(e.src, e.callback)
                    }
                  ),
  ...
  var Lf = (function () {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              for (
                ...
                if (
                  e.hasAttribute("data-prevent-swipe")
                )
                  return !0
                e = e.parentNode
              }
    ...
    Hf = Array.prototype
  null == Hf[zf] &&
    Ff.f(Hf, zf, { configurable: !0, value: jf(null) })
  var Uf = function (e) {
    Hf[zf][e] = !0
  }
  $t(
  ...
  function Wf(e, t) {
    ...
    function q(e) {
      ...
      if (3 === e.nodeType) t += e.textContent
        ...
        "true" === n ||
          i ||
          Array.from(e.childNodes).forEach(function (
            e
          ) {
            t += q(e)
          })
    ...
    function W() {
      setInterval(function () {
        ;(0 === v.wrapper.scrollTop &&
          0 === v.wrapper.scrollLeft) ||
          ((v.wrapper.scrollTop = 0),
    ...
    function $() {
      window.addEventListener("resize", rt, !1),
        ...
        P.bind(),
        T.bind(),
        v.slides.addEventListener("click", it, !1),
        v.slides.addEventListener(
          "transitionend",
          nt,
          !1
        ),
        v.pauseOverlay.addEventListener(
          "click",
          me,
          !1
        ),
    ...
    function X() {
      O.unbind(),
        ...
        v.slides.removeEventListener("click", it, !1),
        v.slides.removeEventListener(
          "transitionend",
          nt,
          !1
        ),
        v.pauseOverlay.removeEventListener(
          "click",
          me,
          !1
        )
    ...
    function Q(e) {
      "string" == typeof e.layout &&
        (f.layout = e.layout),
        "string" == typeof e.overview &&
          (f.overview = e.overview),
        f.layout
    ...
    function te() {
      var e =
        arguments.length > 0 && void 0 !== arguments[0]
          ...
          : "a"
      Array.from(
        v.wrapper.querySelectorAll(e)
      ).forEach(function (e) {
        ;/^(http|www)/gi.test(
          e.getAttribute("href")
        ) && e.addEventListener("click", st, !1)
      })
    }
    function ne() {
      var e =
      ...
      Array.from(
        ...
        ;/^(http|www)/gi.test(
          e.getAttribute("href")
        ) && e.removeEventListener("click", st, !1)
      })
    }
    function ie(e) {
      oe(),
        ...
        if (!l.disableLayout) {
          ...
          for (
            ...
            "none" !== a.style.display &&
              (l.center ||
              a.classList.contains("center")
                ? a.classList.contains("stack")
                  ? (a.style.top = 0)
                  : (a.style.top =
                      Math.max(
                        (e.height - a.scrollHeight) /
                          2,
                        0
                      ) + "px")
                : (a.style.top = ""))
          ...
          t !== h &&
            Z({
              type: "resize",
              data: { oldScale: t, scale: h, size: e },
            })
        }
        C.update(),
          k.updateParallax(),
    ...
    function ce(e, t) {
      var n = {
        ...
        presentationHeight:
          t || v.wrapper.offsetHeight,
      }
      return (
        (n.presentationWidth -=
          n.presentationWidth * l.margin),
        (n.presentationHeight -=
          n.presentationHeight * l.margin),
        "string" == typeof n.width &&
          /%$/.test(n.width) &&
          (n.width =
            (parseInt(n.width, 10) / 100) *
            n.presentationWidth),
        "string" == typeof n.height &&
          /%$/.test(n.height) &&
          (n.height =
            (parseInt(n.height, 10) / 100) *
            n.presentationHeight),
        n
      )
    }
    ...
    function fe() {
      return !(!a || !he(a)) && !a.nextElementSibling
    }
    function ve() {
      return 0 === n && 0 === i
    }
    function ge() {
      return (
        ...
        (!he(a) || !a.parentNode.nextElementSibling)
      )
    }
    function pe() {
      if (l.pause) {
    ...
    function Ee(e, t, o, s) {
      if (
        ...
        if (0 !== c.length) {
          ...
          var h = n || 0,
            f = i || 0
          ;(n = Le(of, void 0 === e ? n : e)),
            (i = Le(sf, void 0 === t ? i : t))
          var p = n !== h || i !== f
          p || (r = null)
          var m = c[n],
          ...
          o.classList.remove("past"),
            ...
            r
              ...
              ? (o.classList.add(
                ...
                l.fragments &&
                  yh(o, ".fragment").forEach(function (
                    e
                  ) {
                    e.classList.add("visible"),
                      e.classList.remove(
    ...
    function Ne() {
      ...
      e: for (var i = 0; i < t.length; i++) {
        for (
          var r = t[i],
            o = r.querySelectorAll("section"),
            s = 0;
          s < o.length;
          s++
        ) {
          if (o[s] === e) break e
          "uncounted" !== o[s].dataset.visibility &&
            n++
        }
        if (r === e) break
    ...
    function Ie() {
      ...
      if (a) {
        ...
        if (n.length > 0) {
          t +=
            (a.querySelectorAll(".fragment.visible")
              .length /
              n.length) *
            0.9
        }
    ...
    function Me(e) {
      ...
      if (e) {
        ...
        ;(r = Math.max(c.indexOf(l), 0)),
          ...
          s &&
            (o = Math.max(
              yh(e.parentNode, "section").indexOf(e),
              0
            ))
      }
      if (
    ...
    function We(e) {
      if ("object" === Si(e)) {
        Ee(wh(e.indexh), wh(e.indexv), wh(e.indexf))
        var t = wh(e.paused),
          n = wh(e.overview)
        "boolean" == typeof t && t !== be() && ye(t),
          "boolean" == typeof n &&
            n !== R.isActive() &&
            R.toggle(n)
      }
    ...
    function Ve() {
      if ((Ke(), a && !1 !== l.autoSlide)) {
        ...
        t
          ...
          : ((p = l.autoSlide),
            0 ===
              a.querySelectorAll(".fragment").length &&
              yh(a, "video, audio").forEach(function (
                e
              ) {
      ...
      ;(u.hasNavigatedHorizontally = !0),
        l.rtl
          ? (R.isActive() || r || !1 === A.next()) &&
            ...
            Ee(
              n + 1,
              "grid" === l.navigationMode ? i : void 0
            )
    ...
    function Ze() {
      ...
      if (r || !1 === A.prev())
        if (Ce().up) Je({ skipFragments: r })
          ...
          var a =
              e.querySelectorAll("section").length -
                1 || void 0,
            o = n - 1
          Ee(o, a)
        } else Xe({ skipFragments: r })
    }
    function et() {
      var e =
          arguments.length > 0 &&
    ...
    function it(e) {
      ...
      if (t) {
        ...
        i &&
          (s.slide(i.h, i.v, i.f), e.preventDefault())
      }
    }
    function rt(e) {
      se()
    ...
    var ct = {
      ...
      registerKeyboardShortcut:
        x.registerKeyboardShortcut.bind(x),
      ...
      mh(
        ...
        wi(
          ...
          {},
          {
            ...
            onUserInput: tt,
            closeOverlay: oe,
            updateSlidesVisibility: Pe,
            layoutSlideContents: le,
            transformSlides: Q,
            cueAutoSlide: Ve,
            cancelAutoSlide: Ke,
          }
  ...
  return (
    (Vf.initialize = function (e) {
      return (
        Object.assign(
          Vf,
          new Wf(document.querySelector(".reveal"), e)
        ),
        Kf.map(function (e) {
          return e(Vf)
        }),
