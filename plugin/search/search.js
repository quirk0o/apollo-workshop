!(function (e, t) {
  ...
  ;(lt.exports = function (e, t, n, r) {
    ...
    return (
      ("function" == typeof this && Kt(this).source) ||
      zt(this)
    )
  })
  var Gt = Le,
    ...
    for (
      var yn = function (e, t) {
          var n,
            ...
            o = tn(e),
            i = void 0 === t
          if (!r && o && e.constructor === yn && i)
            return e
          gn
            ? o && !i && (e = e.source)
            : e instanceof yn &&
              (i && (t = nn.call(e)), (e = e.source)),
            hn &&
              (n = !!t && t.indexOf("y") > -1) &&
              (t = t.replace(/y/g, ""))
          var c = Qt(
            gn ? new fn(e, t) : fn(e, t),
            r ? this : sn,
            yn
          )
          hn && n && (an(c).sticky = !0)
    ...
    return [
      ...
      function (e, r) {
        ...
        for (var d = []; ; ) {
          ...
          if ((d.push(g), !s)) break
          "" === String(g[0]) &&
            (u.lastIndex = Kr(l, Dr(u.lastIndex), p))
        }
        for (
          var h, y = "", v = 0, x = 0;
          x < d.length;
  ...
  var qr = "[object z]" === String(Yr),
    ...
    ro = eo
  to ||
    no(Object.prototype, "toString", ro, {
      unsafe: !0,
    })
  /*!
    ...
    function f(t, n) {
      ...
      ;(this.setRegex = function (e) {
        ...
        (this.remove = function () {
          for (
            var e,
              t = document.getElementsByTagName(o);
            t.length && (e = t[0]);
