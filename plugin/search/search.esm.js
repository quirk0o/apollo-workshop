...
;(ut.exports = function (e, t, n, r) {
  ...
  return (
    ("function" == typeof this && Ft(this).source) ||
    Dt(this)
  )
})
var Bt = $e,
  ...
  for (
    var dn = function (e, t) {
        var n,
          ...
          o = Zt(e),
          i = void 0 === t
        if (!r && o && e.constructor === dn && i)
          return e
        pn
          ? o && !i && (e = e.source)
          : e instanceof dn &&
            (i && (t = en.call(e)), (e = e.source)),
          gn &&
            (n = !!t && t.indexOf("y") > -1) &&
            (t = t.replace(/y/g, ""))
        var c = Ht(
          pn ? new un(e, t) : un(e, t),
          r ? this : ln,
          dn
        )
        gn && n && (on(c).sticky = !0)
  ...
  return [
    ...
    function (e, r) {
      ...
      for (var g = []; ; ) {
        ...
        if ((g.push(d), !s)) break
        "" === String(d[0]) &&
          (u.lastIndex = Dr(l, Lr(u.lastIndex), p))
      }
      for (
        var h, y = "", v = 0, x = 0;
        x < g.length;
...
var Gr = "[object z]" === String(Wr),
  ...
  eo = Jr
Qr ||
  Zr(Object.prototype, "toString", eo, { unsafe: !0 })
/*!
