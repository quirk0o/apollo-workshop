!(function (e, o) {
   ...
   */ var e = {
      id: "zoom",
      init: function (e) {
        e.getRevealElement().addEventListener(
          "mousedown",
          function (t) {
            var n = /Linux/.test(
              ...
              i =
                (e.getConfig().zoomKey
                  ? e.getConfig().zoomKey
                  : n) + "Key",
              d = e.getConfig().zoomLevel
                ? e.getConfig().zoomLevel
                : 2
            t[i] &&
              !e.isOverview() &&
              (t.preventDefault(),
    ...
    o = (function () {
      ...
      function r(o, t) {
        ...
        if (
          ...
          (o.height = o.height || 1),
          (o.x -=
            (window.innerWidth - o.width * t) / 2),
          (o.y -=
            (window.innerHeight - o.height * t) / 2),
          s)
        )
          if (1 === t)
