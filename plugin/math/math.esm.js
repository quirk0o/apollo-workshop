...
;(Z.exports = function (t, e, n, r) {
  ...
  return (
    ("function" == typeof this && zt(this).source) ||
    Ht(this)
  )
})
var Ut = n,
...
var Cn = "[object z]" === String(Rn),
  ...
  qn = Hn
zn ||
  Wn(Object.prototype, "toString", qn, { unsafe: !0 })
var Un = n.Promise,
  Kn = Z.exports,
  Qn = w,
  Xn = W,
  ...
  wr = function (t) {
    if (null != t)
      return t[vr] || t["@@iterator"] || hr[pr(t)]
  },
  jr = function (t) {
    var e = t.return
...
;(Wr && qr) ||
  ...
  Hr
    ...
    : Nr.addEventListener &&
      ...
      !Fr(to)
    ? ((Pr = to),
      Nr.addEventListener("message", Zr, !1))
    : (Pr =
...
var eo,
  ...
  go = Cr,
  mo =
    lo.MutationObserver || lo.WebKitMutationObserver,
  bo = lo.document,
  wo = lo.process,
  jo = lo.Promise,
...
var _o,
  ...
  Yo = function (t, e, n) {
    ...
    for (u = r.next; !(f = u.call(r)).done; ) {
      ...
      if ("object" == typeof c && c && c instanceof xr)
        return c
    }
    return new xr(!1)
  },
  ...
  Vo = function (t, e) {
    var n,
      r = Lr(t).constructor
    return void 0 === r || null == (n = Lr(r)[Ar])
      ? e
      : Mr(n)
  },
  Zo = fo.set,
  ...
  Ti = ai(li, function () {
    ...
    return (
      ((e.constructor = {})[si] = n),
      !(Si = e.then(function () {}) instanceof n) ||
        (!t && ci && !Ei)
    )
  }),
  Pi =
    ...
    Oi
      ...
      !Ei && (o = Jo["on" + t])
        ...
        : "unhandledrejection" === t &&
          ni("Unhandled promise rejection", n)
  },
  Mi = function (t) {
    Zo.call(Jo, function () {
      var e,
  ...
  Ii = function (t) {
    Zo.call(Jo, function () {
      var e = t.facade
      ui
        ? wi.emit("rejectionHandled", e)
        : Li("rejectionhandled", e, t.value)
    })
  },
  Ri = function (t, e, n) {
    return function (r) {
  ...
  Bi = function () {
    ...
    Bi = Fi
      ...
      : (((e = Ki("iframe")).style.display = "none"),
        ...
        t.close(),
        t.F)
    for (var n = Wi.length; n--; )
      delete Bi.prototype[Wi[n]]
    return Bi()
  }
qi[Qi] = !0
var Vi =
  ...
  ea = Array.prototype
null == ea[ta] &&
  Zi.f(ea, ta, { configurable: !0, value: Vi(null) })
var na = se.includes,
  ra = function (t) {
    ea[ta][t] = !0
  }
