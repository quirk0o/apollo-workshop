!(function (t, e) {
  ...
  ;(Z.exports = function (t, e, n, r) {
    ...
    return (
      ("function" == typeof this && qt(this).source) ||
      Wt(this)
    )
  })
  var Qt = n,
  ...
  var Fn = "[object z]" === String(Nn),
    ...
    Kn = Wn
  qn ||
    Un(Object.prototype, "toString", Kn, {
      unsafe: !0,
    })
  var Qn = n.Promise,
    Xn = Z.exports,
    ...
    xr = function (t) {
      if (null != t)
        return t[yr] || t["@@iterator"] || vr[dr(t)]
    },
    Or = function (t) {
      var e = t.return
  ...
  ;(Ur && Kr) ||
    ...
    Wr
      ...
      : Jr.addEventListener &&
        ...
        !Dr(ro)
      ? ((kr = ro),
        Jr.addEventListener("message", no, !1))
      : (kr =
          Zr in Hr("script")
            ? function (t) {
                Gr.appendChild(
  ...
  var oo,
    ...
    wo = Fr,
    jo =
      vo.MutationObserver || vo.WebKitMutationObserver,
    xo = vo.document,
    Oo = vo.process,
    Eo = vo.Promise,
  ...
  To ||
    ...
    mo || wo || bo || !jo || !xo
      ? Eo && Eo.resolve
        ? (((so = Eo.resolve(void 0)).constructor =
            Eo),
          (lo = so.then),
          (co = function () {
            lo.call(so, oo)
  ...
  var _o,
    ...
    ei = function (t, e) {
      var n,
        r = Ar(t).constructor
      return void 0 === r || null == (n = Ar(r)[Rr])
        ? e
        : Ir(n)
    },
    ni = po.set,
    ...
    Li = fi(di, function () {
      ...
      return (
        ((e.constructor = {})[hi] = n),
        !(ki = e.then(function () {}) instanceof n) ||
          (!t && si && !Pi)
      )
    }),
    _i =
    ...
    Ri = function (t, e, n) {
      ...
      Ti
        ...
        !Pi && (o = Go["on" + t])
          ? o(r)
          : t === Mi &&
            ii("Unhandled promise rejection", n)
    },
    Ci = function (t) {
      ni.call(Go, function () {
        var e,
        ...
        if (
          ...
          ((e = ci(function () {
            li
              ? Oi.emit("unhandledRejection", r, n)
              : Ri(Mi, n, r)
          })),
    ...
    ea = function () {
      ...
      ea = Gi
        ...
        : (((e = Bi("iframe")).style.display = "none"),
          ...
          t.close(),
          t.F)
      for (var n = Qi.length; n--; )
        delete ea.prototype[Qi[n]]
      return ea()
    }
  Xi[Vi] = !0
  var na =
    ...
    ia = Array.prototype
  null == ia[oa] &&
    ra.f(ia, oa, { configurable: !0, value: na(null) })
  var aa = pe.includes,
    ca = function (t) {
      ia[oa][t] = !0
    }
    ...
    KaTeX: function () {
      ...
      return {
        ...
        init: function (n) {
          ...
          ;(d = s),
            ((v = document.createElement("link")).rel =
              "stylesheet"),
            (v.href = d),
